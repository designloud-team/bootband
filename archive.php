<?php get_header(); ?>
			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col-sm-8 clearfix" role="main">
					...
					<?php } elseif (is_tag()) { ?>
						<h1 class="archive_title h2">
							<span><?php _e("Posts Tagged:", "bootband"); ?></span> <?php single_tag_title(); ?>
						</h1>
					<?php } elseif (is_author()) { ?>
						<h1 class="archive_title h2">
							<span><?php _e("Posts By:", "bootband"); ?></span> <?php get_the_author_meta('display_name'); ?>
						</h1>
					<?php } elseif (is_day()) { ?>
						<h1 class="archive_title h2">
							<span><?php _e("Daily Archives:", "bootband"); ?></span> <?php the_time('l, F j, Y'); ?>
						</h1>
					<?php } elseif (is_month()) { ?>
						<h1 class="archive_title h2">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<section class="post_content">
							...
							<?php the_post_thumbnail( 'bb-featured' ); ?>
					...
					<article id="post-not-found">
						<header>
							<h1><?php _e("No Posts Yet", "bootband"); ?></h1>
						</header>
						<section class="post_content">
							<p><?php _e("Sorry, What you were looking for is not here.", "bootband"); ?></p>
						</section>
						<footer>
						</footer>
					</article>
