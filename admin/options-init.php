	...
	class Redux_Framework_sample_config {
		...
		public function setSections() {
			...
			$this->sections[] = array(
				...
				'desc'     => __('Declare any social networks here.', 'redux-framework-demo'),
				'icon'     => 'el-icon-group',
				'fields'   => array(
					array(
						'id'        => 'switch-facebook',
						...
						'subtitle'  => __('Toggle Facebook icon.', 'redux-framework-demo'),
						'default'   => 0,
						'on'        => 'Yes',
						'off'       => 'No',
					),
					array(
						'id'        => 'section-facebook-start',
						'type'      => 'section',
						...
						'required'  => array('switch-facebook', "=", 1),
					),
					array(
						'id'        => 'facebook-url',
						'type'      => 'text',
						...
						'subtitle'  => __('Copy and paste URL here.', 'redux-framework-demo'),
					...
					array(
						...
						'subtitle'  => __('Toggle Twitter icon.', 'redux-framework-demo'),
						'default'   => 0,
						'on'        => 'Yes',
						'off'       => 'No',
					),
					array(
						'id'        => 'section-twitter-start',
						'type'      => 'section',
						//'title'     => __('Media Options', 'redux-framework-demo'),
						//'subtitle'  => __('With the "section" field you can create indent option sections.', 'redux-framework-demo'),
						'indent'    => true, // Indent all options below until the next 'section' option is set.
						'required'  => array('switch-twitter', "=", 1),
					),
					array(
						'id'        => 'twitter-url',
						'type'      => 'text',
					...
					array(
						'id'        => 'section-twitter-end',
						'type'      => 'section',
						'indent'    => false, // Indent all options below until the next 'section' option is set.
						'required'  => array('switch-twitter', "=", 1),
					),
					array(
						'id'        => 'switch-googleplus',
						'type'      => 'switch',
						'title'     => __('Google+', 'redux-framework-demo'),
						'subtitle'  => __('Toggle Google+ icon.', 'redux-framework-demo'),
						'default'   => 0,
						'on'        => 'Yes',
						'off'       => 'No',
					),
					array(
						'id'        => 'section-googleplus-start',
						'type'      => 'section',
						//'title'     => __('Media Options', 'redux-framework-demo'),
						//'subtitle'  => __('With the "section" field you can create indent option sections.', 'redux-framework-demo'),
						'indent'    => true, // Indent all options below until the next 'section' option is set.
						'required'  => array('switch-googleplus', "=", 1),
					),
					array(
						'id'        => 'googleplus-url',
						'type'      => 'text',
					...
					array(
						...
						'subtitle'  => __('Toggle LinkedIn icon.', 'redux-framework-demo'),
						'default'   => 0,
						'on'        => 'Yes',
						'off'       => 'No',
					),
					array(
						'id'        => 'section-linkedin-start',
						'type'      => 'section',
						//'title'     => __('Media Options', 'redux-framework-demo'),
						//'subtitle'  => __('With the "section" field you can create indent option sections.', 'redux-framework-demo'),
						'indent'    => true, // Indent all options below until the next 'section' option is set.
						'required'  => array('switch-linkedin', "=", 1),
					),
					array(
						'id'        => 'linkedin-url',
						'type'      => 'text',
					...
					array(
						...
						'subtitle'  => __('Toggle Instagram icon.', 'redux-framework-demo'),
						'default'   => 0,
						'on'        => 'Yes',
						'off'       => 'No',
					),
					array(
						'id'        => 'section-instagram-start',
						'type'      => 'section',
						//'title'     => __('Media Options', 'redux-framework-demo'),
						//'subtitle'  => __('With the "section" field you can create indent option sections.', 'redux-framework-demo'),
						'indent'    => true, // Indent all options below until the next 'section' option is set.
						'required'  => array('switch-instagram', "=", 1),
					),
					array(
						'id'        => 'instagram-url',
						'type'      => 'text',
					...
					array(
						...
						'subtitle'  => __('Toggle Pinterest icon.', 'redux-framework-demo'),
						'default'   => 0,
						'on'        => 'Yes',
						'off'       => 'No',
					),
					array(
						'id'        => 'section-pinterest-start',
						'type'      => 'section',
						//'title'     => __('Media Options', 'redux-framework-demo'),
						//'subtitle'  => __('With the "section" field you can create indent option sections.', 'redux-framework-demo'),
						'indent'    => true, // Indent all options below until the next 'section' option is set.
						'required'  => array('switch-pinterest', "=", 1),
					),
					array(
						'id'        => 'pinterest-url',
						'type'      => 'text',
					...
					array(
						...
						'subtitle'  => __('Toggle YouTube icon.', 'redux-framework-demo'),
						'default'   => 0,
						'on'        => 'Yes',
						'off'       => 'No',
					),
					array(
						'id'        => 'section-youtube-start',
						'type'      => 'section',
						//'title'     => __('Media Options', 'redux-framework-demo'),
						//'subtitle'  => __('With the "section" field you can create indent option sections.', 'redux-framework-demo'),
						'indent'    => true, // Indent all options below until the next 'section' option is set.
						'required'  => array('switch-youtube', "=", 1),
					),
					array(
						'id'        => 'youtube-url',
						'type'      => 'text',
					...
					array(
						...
						'subtitle'  => __('Toggle Vimeo icon.', 'redux-framework-demo'),
						'default'   => 0,
						'on'        => 'Yes',
						'off'       => 'No',
					),
					array(
						'id'        => 'section-vimeo-start',
						'type'      => 'section',
						//'title'     => __('Media Options', 'redux-framework-demo'),
						//'subtitle'  => __('With the "section" field you can create indent option sections.', 'redux-framework-demo'),
						'indent'    => true, // Indent all options below until the next 'section' option is set.
						'required'  => array('switch-vimeo', "=", 1),
					),
					array(
						'id'        => 'vimeo-url',
						'type'      => 'text',
...
//                        )
			...
			$this->sections[] = array(
				...
				'desc'      => __('Import and Export your theme options settings from a file or URL.', 'redux-framework-demo'),
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'opt_name'          => 'redux_opt',            // This is where your data is stored in the database and also becomes your global variable name.
			...
			if (!isset($this->args['global_variable']) || $this->args['global_variable'] !== false) {
				...
				$this->args['intro_text'] = sprintf(__('<p>Welcome to your theme options panel! This is where you can set and change various options that control various parts of your site.</p>', 'redux-framework-demo'), $v);
			} else {
