				...
				<div id="main" class="col-sm-8 clearfix" role="main">
					...
					<?php } else { // if it is disabled, display regular wp prev & next links ?>
						<nav class="wp-prev-next">
							<ul class="clearfix">
								<li class="prev-link"><?php next_posts_link(_e('&laquo; Older Entries', "bootband")) ?></li>
								<li class="next-link"><?php previous_posts_link(_e('Newer Entries &raquo;', "bootband")) ?></li>
							</ul>
						</nav>
					<?php } ?>
