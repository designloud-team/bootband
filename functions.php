...
// Thumbnail sizes
add_image_size( 'bb-featured', 780, 300, true );
add_image_size( 'bb-featured-home', 970, 311, true);
add_image_size( 'bb-featured-carousel', 970, 400, true);
...
function bootband_register_sidebars() {
...
// Comment Layout
function bootband_comments($comment, $args, $depth) {
		...
		<article id="comment-<?php comment_ID(); ?>" class="clearfix">
			<div class="comment-author vcard clearfix">
				...
				<div class="col-sm-9 comment-text">
					...
					<?php edit_comment_link(__('Edit','bootband'),'<span class="edit-comment btn btn-sm btn-info"><i class="glyphicon-white glyphicon-pencil"></i>','</span>') ?>

					<?php if ($comment->comment_approved == '0') : ?>
					<div class="alert-message success">
						<p><?php _e('Your comment is awaiting moderation.','bootband') ?></p>
					</div>
				<?php endif; ?>
...
function list_pings($comment, $args, $depth) {
	...
	function custom_password_form() {
		...
		' . '<p>' . __( "This post is password protected. To view it please enter your password below:" ,'bootband') . '</p>' . '
		<label for="' . $label . '">' . __( "Password:" ,'bootband') . ' </label><div class="input-append"><input name="post_password" id="' . $label . '" type="password" size="20" /><input type="submit" name="Submit" class="btn btn-primary" value="' . esc_attr__( "Submit",'bootband' ) . '" /></div>
		</form></div>
		';
		return $o;
	}
...
function show_homepage_meta_box() {
	...
	wp_nonce_field( basename( __FILE__ ), 'bb_nonce' );
...
function save_homepage_meta( $post_id ) {
	...
	// verify nonce
	if ( !isset( $_POST['bb_nonce'] ) || !wp_verify_nonce($_POST['bb_nonce'], basename(__FILE__)) )
		return $post_id;
